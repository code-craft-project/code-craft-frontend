...
export default function Toast() {
    ...
    return (
        <div className="w-full fixed top-0 left-0 flex flex-col items-center my-4 z-50">
            {
                toastManager.messages.map((message: ToastMessage, index: number) => {
                    return (
...
function Message({ message }: { message: ToastMessage }) {
    if (message.type == "success") {
        return (
            <div id="toast-success" className="flex items-centerz w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg border-2 dark:border-none shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
